...
Usage :
    python dealabs_scraper.py --env=local --city=1 --dry-run
    python dealabs_scraper.py --env=local --city=1 --mode=all
    python dealabs_scraper.py --env=local --city=1 --mode=brands --brands="amazon,nike,shein,disneyland-paris"
    python dealabs_scraper.py --env=local --city=1 --mode=homepage
    python dealabs_scraper.py --env=local --city=1 --mode=top-codes
    python dealabs_scraper.py --env=local --city=1 --mode=all --min-temp=100
...
def main():
    ...
    log(f"=== dealabs_scraper v2 — env={args.env} city={args.city} mode={mode}{tag} ===")
    if min_temp is not None:
